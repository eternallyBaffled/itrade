...
registerListSymbolConnector('SWISS EXCHANGE','XSWX',QList.any,QTAG_LIST,Import_ListOfQuotes_SWX)
registerListSymbolConnector('SWISS EXCHANGE','XVTX',QList.any,QTAG_LIST,Import_ListOfQuotes_SWX)
