            ...
            for line in linesjp:
                ...
                if n == 1:
                    ...
                    if '<td><small>' in line:
                        ...
                        if i == 1 :
                            sdate = data
                            sdate = sdate.replace('Ç¯',' ')
                            sdate = sdate.replace('·î',' ')
                            sdate = sdate.replace('Æü','')
                            sdate = sdate.split()
...
registerImportConnector('TOKYO EXCHANGE', 'TKS', QList.any, QTAG_IMPORT, gImportYahoojp, bDefault=True)
